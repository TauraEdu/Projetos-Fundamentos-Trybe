...
describe('6 - Implemente os casos de teste para a função `productDetails`', () => {
  it('Verifica se a função `productDetails` tem o comportamento esperado', () => {
    ...
    expect(Object.values(productDetails('itemA', 'itemB')[0].details)[0].slice(-3)).toBe('123');
    expect(Object.values(productDetails('itema', 'itemb')[1].details)[0].slice(-3)).toBe('123');
  });
});
